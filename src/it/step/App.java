...
public class App {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter which way you want !");
        temp = reader.readString("Which way ?");
                ...
                switch (option) {
                    case "1":
                       ...
                       // do {
                        ...
                        manager.create(id, name, surname, gender, LocalDate.parse(birthdate, DateTimeFormatter.ofPattern("dd/MM/y")));
                        id++;
                    ...
                    case "4":
                        ...
                        if (checkValidOption(temp)) {
                            try {
                                ...
                                manager.update(0,"","","",LocalDate.of(1,1,1));
                                ...
                                birthdate = reader.readString("Enter birthdate :");
                                manager.update(Integer.parseInt(temp) - 1, name, surname, gender,LocalDate.parse(birthdate,DateTimeFormatter.ofPattern("dd/MM/y")));
